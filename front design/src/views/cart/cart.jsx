...
//     try {
//       await axios.delete(`http://localhost:5002/remove-from-cart/${productId}/${customerId}`);
//       setCart(prevCart => ({
//         ...prevCart,
...
//     try {
//       await axios.delete(`http://localhost:5002/clear-cart/${customerId}`);
//       setCart(null);
//       window.location.reload(); // Reload the page after clearing the cart
...
//               <Button onClick={clearCart} className='btn-global text-light my-3'>Clear Cart</Button>
              // <Button onClick={() => { window.location.replace(`/checkout`) }} className='btn-global w-100 text-light my-3'>Checkout</Button>
//             </div>
//           ) : (
//             <p>Cart is empty</p>
//           )}
