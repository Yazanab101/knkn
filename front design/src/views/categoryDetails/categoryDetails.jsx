...
//           `http://localhost:5002/restaurant/${resName}/category/${categoryName}/dishes`
//         );
...
//       ...prevSelectedExtras,
//       [extraId]: !prevSelectedExtras[extraId], // Toggle the selection
//     }));
//   };
...
//       const response = await axios.post(`http://localhost:5002/add-to-cart/${customerId}`, {
//         name,
//         description,
//         price,
//         productId,
...
//     if (isAdmin || isOwner) {
//       try {
//         await axios.delete(`http://localhost:5002/delete-dish/${resName}/${categoryName}/${productId}`);
...
//                       <RemoveIcon />
//                     </Button>
//                     <span className="fw-bold quantity" style={{ margin: '0 2vw' }}>{quantities[selectedProduct._id]}</span>
//                     <Button
//                       className="fw-bold"
//                       onClick={() => handleQuantityChange(selectedProduct._id, 1)}
//                     >
