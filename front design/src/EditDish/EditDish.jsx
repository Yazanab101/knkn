...
export default function EditRestaurant() {
  ...
  useEffect(() => {
    const fetchDish = async () => {
      try {
        ...
        const response = await axios.get(`http://localhost:5002/dishes/${dishId}`,{headers});
  ...
  const handleUpdate = async () => {
    try {
     ...
     const res= await axios.put(`http://localhost:5002/update-dish/${resName}/${categoryName}/${dishId}`, {
